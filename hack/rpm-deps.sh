...
LIBVIRT_VERSION=${LIBVIRT_VERSION:0:11.9.0-2.el10_rc.d04e060e4f}
QEMU_VERSION=${QEMU_VERSION:10.0.0-7.el10}
SEABIOS_VERSION=${SEABIOS_VERSION:1.16.3-8.el10}
EDK2_VERSION=${EDK2_VERSION:20250822-1.el10}
LIBGUESTFS_VERSION=${LIBGUESTFS_VERSION:1.57.5-1.el10}
GUESTFSTOOLS_VERSION=${GUESTFSTOOLS_VERSION:1.54.0-6.el10}
PASST_VERSION=${PASST_VERSION:0^20250512.g8ec1341-2.el10}
VIRTIOFSD_VERSION=${VIRTIOFSD_VERSION:1.13.2-1.el10}
SWTPM_VERSION=${SWTPM_VERSION:0.9.0-2.el10}
